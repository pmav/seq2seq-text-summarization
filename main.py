...
#region Dataset spliting

x_tr, x_val, y_tr, y_val = train_test_split(np.array(df['text']), np.array(df['summary']), test_size=0.1, random_state=0, shuffle=True)

#endregion

#region Tokenizer for reviews
...
#region Tokenizer for summaries
